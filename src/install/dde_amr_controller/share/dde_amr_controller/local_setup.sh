...
: ${AMENT_CURRENT_PREFIX:="/home/tommyu22/dde_amr_ws/src/install/dde_amr_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dde_amr_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dde_amr_controller/environment/path.sh"
